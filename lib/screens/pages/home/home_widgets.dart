      ...
      child: Column(
        ...
        children: [
          ...
          if (showAbstract) ...[
            SizedBox(height: 24),
            Typewriter(
              "I build neat, cool and scalable mobile apps with Flutter and I'm an aspiring machine learning engineer.\n"
...
class __HireMeButtonState extends State<_HireMeButton> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        UrlHelper.launchUrl("mailto:samieruashovo@gmail.com");
      },
      onHover: (value) {
        if (mounted) {
          setState(() {
